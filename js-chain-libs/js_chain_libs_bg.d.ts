...
export function transactionbuilder_set_certificate(a: number, b: number): void;
...
export function transactionbuilder_get_txid(a: number): number;
...
export function __wbg_generatedtransaction_free(a: number): void;
export function generatedtransaction_id(a: number): number;
export function generatedtransaction_transaction(a: number): number;
...
export function certificate_to_bech32(a: number, b: number): void;
export function __wbg_stakepoolinfo_free(a: number): void;
export function stakepoolinfo_new(a: number, b: number, c: number, d: number): number;
export function stakepoolinfo_id(a: number): number;
export function __wbg_stakepoolid_free(a: number): void;
export function stakepoolid_from_hex(a: number, b: number): number;
...
export function fragment_is_certificate(a: number): number;
